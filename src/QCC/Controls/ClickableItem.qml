...
Item {
    ...
    //    property alias released: controlMouseArea.released

    property alias cursorShape: controlMouseArea.cursorShape

    property alias drag: controlMouseArea.drag
    ...
    MouseArea {
        ...
        onPressed: {
            if(control.clickable) control.state = "pressed"
        }

        onReleased: {
            if(control.clickable) control.state = "rest"
        }
